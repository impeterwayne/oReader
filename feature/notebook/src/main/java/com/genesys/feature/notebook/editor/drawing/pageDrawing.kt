...
import com.genesys.feature.notebook.editor.utils.imageBounds
...
private val pageDrawingLog = "PageDrawingLog" // Logger tag
...
fun drawImage(context: Context, canvas: Canvas, image: Image, offset: Offset) {
    ...
    val imageBitmap = uriToBitmap(context, uri.toUri())?.asImageBitmap()
    if (imageBitmap != null) {

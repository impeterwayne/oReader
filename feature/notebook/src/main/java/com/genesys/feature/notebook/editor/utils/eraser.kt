...
// Eraser is defined in com.genesys.feature.notebook.editor.state.EditorTypes
// Re-exported here via its import for backward compatibility.
...
private fun calculateStrokeLength(points: List<NotebookStrokePoint>): Float {
...
private fun calculateNumReversals(
    points: List<NotebookStrokePoint>, stepSize: Int = 10
): Int {
    var numReversals = 0
...
private fun filterStrokesByIntersection(
    candidateStrokes: List<NotebookStroke>,
    boundingBox: RectF,
...
fun handleScribbleToErase(
    page: PageView,
    touchPoints: List<NotebookStrokePoint>,
    history: History,
    pen: Pen,
    ...
    // TODO: Check scribbleToEraseEnabled from settings
    // if (!settingsProvider.scribbleToEraseEnabled) return null

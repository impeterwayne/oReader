...
import com.genesys.feature.notebook.editor.utils.calculateBoundingBox
import com.genesys.feature.notebook.editor.utils.copyInput
import com.genesys.feature.notebook.editor.utils.copyInputToSimplePointF
import com.genesys.feature.notebook.editor.utils.getModifiedStrokeEndpoints
import com.genesys.feature.notebook.editor.utils.handleDraw
import com.genesys.feature.notebook.editor.utils.handleErase
import com.genesys.feature.notebook.editor.utils.handleScribbleToErase
import com.genesys.feature.notebook.editor.utils.handleSelect
import com.genesys.feature.notebook.editor.utils.onSurfaceInit
import com.genesys.feature.notebook.editor.utils.partialRefreshRegionOnce
import com.genesys.feature.notebook.editor.utils.penToStroke
import com.genesys.feature.notebook.editor.utils.prepareForPartialUpdate
import com.genesys.feature.notebook.editor.utils.restoreDefaults
import com.genesys.feature.notebook.editor.utils.setupSurface
import com.genesys.feature.notebook.editor.utils.transformToLine
...
class OnyxInputHandler(
    ...
    private val TAG = "OnyxInputHandler"
    ...
    private val inputCallback: RawInputCallback = object : RawInputCallback() {
        ...
        override fun onBeginRawErasing(p0: Boolean, p1: TouchPoint?) {
            ...
            if (NotebookSettingsProvider.current.openGLRendering) {
                ...
                coroutineScope.launch(Dispatchers.Main.immediate) {
                    CanvasEventBus.drawingInProgress.withLock {
                        ...
                        if (erasedByScribbleDirtyRect.isNullOrEmpty()) {
                            ...
                            Log.d(TAG, "Erased by scribble, $erasedByScribbleDirtyRect")

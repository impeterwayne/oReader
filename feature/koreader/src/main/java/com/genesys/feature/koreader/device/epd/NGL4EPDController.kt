...
package com.genesys.feature.koreader.device.epd

import com.genesys.feature.koreader.device.EPDInterface
import com.genesys.feature.koreader.device.epd.freescale.NTXEPDController
...
class NGL4EPDController : NTXEPDController(), EPDInterface {
                            ...
                            x: Int, y: Int, width: Int, height: Int, epdMode: String?)
    {
       ...
       Timber.tag(NGL4TAG).i(String.format(Locale.US, "calling requestEpdMode: type:%d delay: %d x:%d y:%d w:%d h:%d",

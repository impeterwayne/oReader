...
class MainApp : Application() {
    companion object {
        ...
        const val PROVIDER = "${BuildConfig.HOST_APPLICATION_ID}.provider"
        ...
        fun initialize(context: Context) {
            ...
            assets_path = context.filesDir.absolutePath
            ...
            crash_report_path = String.format("%s%s%s", context.cacheDir, File.separator, "crash.log")
            targetSdk = context.applicationInfo.targetSdkVersion

            Thread.setDefaultUncaughtExceptionHandler { thread, throwable ->
                throwable.printStackTrace()
                crashReport(context.applicationContext,

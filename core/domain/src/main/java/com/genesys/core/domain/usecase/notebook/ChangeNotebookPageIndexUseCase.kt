...
class ChangeNotebookPageIndexUseCase @Inject constructor(
    private val notebookRepository: NotebookRepository
) {
    suspend operator fun invoke(notebookId: String, pageId: String, index: Int): Unit {
        return notebookRepository.changePageIndex(notebookId, pageId, index)
    }
}

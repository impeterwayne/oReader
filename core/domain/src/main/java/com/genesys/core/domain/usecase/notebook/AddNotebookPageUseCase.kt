...
class AddNotebookPageUseCase @Inject constructor(
    private val notebookRepository: NotebookRepository
) {
    suspend operator fun invoke(notebookId: String, pageId: String, index: Int? = null): Unit {
        return notebookRepository.addPage(notebookId, pageId, index)
    }
}

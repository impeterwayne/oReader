...
class GetNotebookPageIndexUseCase @Inject constructor(
    private val notebookRepository: NotebookRepository
) {
    suspend operator fun invoke(notebookId: String, pageId: String): Int? {
        return notebookRepository.getPageIndex(notebookId, pageId)
    }
}
